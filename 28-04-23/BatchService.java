...
public class BatchService {
	...
	static AWS course_aws[]= new AWS[10];
...
//		String number = phone_validation(acount);
		...
		course_aws[acount] = new AWS(sid, sname,sphone,semail);
		acount++;
...
//					phone_validation(i); //  check number is valid or not if valid then update it
	...
	public static void checkcourse(String course) throws CourseNotFoundException // check course is available or not
	{
